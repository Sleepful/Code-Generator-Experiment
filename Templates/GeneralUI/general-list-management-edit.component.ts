...
case GeneralManagementEnum.{!FIELDS}:
        ...
        this.detailTitle = this.translatePipe.transform('common-management', '{!FIELD}Detail').value;
        this.confirmDeleteTitle = this.translatePipe.transform('common-management', '{!FIELD}ConfirmDeleteMessage').value;
...
/////////////////////////////////////////////////////////////
      ...
      case GeneralManagementEnum.{!FIELDS}:
        ...
        this.handleDialogEntityOperation(operation, 'common-management', '{!FIELD}Created');
...
/////////////////////////////////////////////////////////////
      ...
      case GeneralManagementEnum.{!FIELDS}:
        ...
        this.handleEntityOperation(operation, 'common-management', '{!FIELD}Updated');
...
/////////////////////////////////////////////////////////////
          ...
          case GeneralManagementEnum.{!FIELDS}:
            ...
            this.handleEntityOperation(operation, 'common-management', '{!FIELD}Deleted');
